...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchTrendData(category, subCategory = null) {
        ...
        fetch(url)
            ...
            .then(data => {
                if (data.success) {
                    ...
                    chart.update();
                    chartTitle.textContent = category.toUpperCase() + (subCategory ? ` - ${subCategory}` : "");
                } else {
    ...
    categorySelect.addEventListener("change", function() {
        ...
        subCategorySelect.style.display = (category === "morbidity" || category === "mortality") ? "block" : "none";
        
        if (category === "population") {
            fetchTrendData("population");
        }
    });
    ...
    subCategorySelect.addEventListener("change", function() {
        ...
        if (subCategory) {
            fetchTrendData(category, subCategory);
        }
    });

    // Load population by default
    fetchTrendData("population");
});
</script>
