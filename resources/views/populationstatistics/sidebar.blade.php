		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item active">
				<a class="sidebar-link" href="{{url('/home')}}">
					<i class="align-middle" data-feather="grid"></i> <span class="align-middle">Population Statistics Overview</span>
				</a>
			</li>
			...
			<li class="sidebar-item">
				<a class="sidebar-link" href="{{url('show_population')}}">
					<i class="align-middle" data-feather="database"></i> <span class="align-middle">Population Statistics</span>
				</a>
			</li>
